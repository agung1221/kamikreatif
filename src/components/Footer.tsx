      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <ul className="space-y-3">
              <li><a href="mailto:kamikreatif.info@gmail.com" className="hover:text-orange-500 transition-colors duration-300">kamikreatif.info@gmail.com</a></li>
              <li><a href="https://wa.me/6281287718683" target="_blank" rel="noopener noreferrer" className="hover:text-orange-500 transition-colors duration-300">(+62) 812-8771-8683</a></li>
