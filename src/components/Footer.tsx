...
const footerLinks = {
    ...
    sosial: [
        { name: "Instagram", href: "https://instagram.com", icon: <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.85s-.012 3.584-.07 4.85c-.148 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07s-3.584-.012-4.85-.07c-3.252-.148-4.771-1.691-4.919-4.919-.058-1.265-.07-1.645-.07-4.85s.012-3.584.07-4.85c.148-3.225 1.664-4.771 4.919-4.919C8.416 2.175 8.796 2.163 12 2.163zm0 1.441c-3.116 0-3.479.011-4.69.068-2.877.13-4.042 1.28-4.172 4.172-.057 1.218-.067 1.575-.067 4.69s.01 3.472.067 4.69c.13 2.892 1.295 4.042 4.172 4.172 1.21.057 1.574.067 4.69.067s3.48-.01 4.69-.067c2.877-.13 4.042-1.28 4.172-4.172.057-1.218.067-1.575.067-4.69s-.01-3.472-.067-4.69c-.13-2.892-1.295-4.042-4.172-4.172-1.21-.057-1.574-.067-4.69-.067zM12 8.25a3.75 3.75 0 100 7.5 3.75 3.75 0 000-7.5zM12 14a2 2 0 110-4 2 2 0 010 4zm6.406-7.875a.938.938 0 00-.938-.938.938.938 0 000 1.875.938.938 0 00.938-.937z" /></svg> },
